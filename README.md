...
```toml
[dependencies]
rlnc = "=0.5.0"                                      # Use the latest version available on crates.io.
# or
rlnc = { version = "=0.5.0", features = "parallel" } # Uses `rayon`-based data-parallelism for much faster encoding/ recoding.
